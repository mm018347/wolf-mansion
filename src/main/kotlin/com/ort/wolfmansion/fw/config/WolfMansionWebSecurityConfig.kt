...
import com.ort.wolfmansion.fw.security.WolfMansionUserDetailService
...
class WolfMansionWebSecurityConfig() : WebSecurityConfigurerAdapter() {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    @Autowired
    private lateinit var userInfoService: WolfMansionUserDetailService

    @Value("\${remember.token: hoge}")
    private var rememberToken: String? = null
