...
public abstract class BsVillagePlayer extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasWiseAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasWiseAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasAstroAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasAstroAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasInvestigateAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasInvestigateAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasTrapAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasTrapAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasBombAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasBombAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isRequestSkillCode_HasAttackWiseAbility() {
        CDef.Skill cdef = getRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasAttackWiseAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasWiseAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasWiseAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasAstroAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasAstroAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasInvestigateAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasInvestigateAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasTrapAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasTrapAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasBombAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasBombAbility();
    }
     ...
     * @return The determination, true or false.
     */
    public boolean isSecondRequestSkillCode_HasAttackWiseAbility() {
        CDef.Skill cdef = getSecondRequestSkillCodeAsSkill();
        return cdef != null && cdef.isHasAttackWiseAbility();
    }
